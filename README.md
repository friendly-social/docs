...
Discussions under that repository are used to chat with developers and everyone is welcome to participate.

Issues are not used, any decisions are stored in a separate `fed` directory as plain markdown files.
